...
| 위험 | 방어책 |
|---|---|
| ~~2026 실제 심사배점 미확인~~ | **해결됨.** `docs/70_official_criteria.md`. 새 위험은 **3페이지 제한** — 만든 것의 대부분을 지면에 못 싣는다 |
...
- [x] **공식 심사항목·배점·제출서식 확보 완료** — `docs/70_official_criteria.md`
      배점: 창의성10/필요성20/시급성20/적절성25/활용성25. 전문가50%+현업20%+온라인30%.
      **기획서 3페이지 초과 금지**, PDF 이메일 제출, 양식 수정 불가
